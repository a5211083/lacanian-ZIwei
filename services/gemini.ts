...
export async function getDetailedAnalysis(
  ...
  if (style === 'Lacanian') styleGn = "拉康概念："+star.lacanConcept[lang], styleDesc = "使用拉康精神分析视角，重点关注实在、想象与象征界的博弈。解释该组合如何影响主体的欲望结构和心理地图。";
  if (style === 'Classic') styleGn = "斗数概念", styleDesc = "采用紫微斗数经典古籍风格，结合命理宿命论。";
  if (style === 'Semiotics') styleGn = "结构主义概念", styleDesc = "使用结构主义符号学，拆解能指与所指。";
  if (style === 'Pictographic') styleGn = "象形概念", styleDesc = "从汉字构件的象形演变与心理原型出发进行解读。";
